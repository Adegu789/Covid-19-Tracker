...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/zahrasalarian/covid19Tracker.svg?branch=master)](https://travis-ci.com/zahrasalarian/covid19Tracker)
<!-- badges: end -->
...
devtools::install_github("zahrasalarian/covid19Tracker")
```
## Website
### You may want to first check the website and see how to get started: https://zahrasalarian.github.io/covid19Tracker/
